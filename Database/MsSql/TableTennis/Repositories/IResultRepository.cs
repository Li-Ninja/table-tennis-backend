...
public interface IResultRepository
{
    ...
    Task<IEnumerable<Result>> ReadAllResult(int? event_id, EventTypeEnum? eventType, SubEventTypeEnum? subEventType, DateTimeOffset? startDate, DateTimeOffset? endDate, int? player_Id_A_1, int? player_Id_B_1);
